...
public class TCM005_Register_PasswordNotMatch {
...
String ConfirmPassword = "tes2t";



		public TCM005_Register_PasswordNotMatch(WebDriver driver) {
			this.driver = driver;
		}
	    ...
	    public void main() throws InterruptedException {
	    	...
	    	Thread.sleep(2000);
	    	Assert.assertEquals(registerPage.verifikasiTextPasswordNotMatch(), "Password Does Not Matches");
