...
public class TCM006_Register_EmailAlreeadyUsed {
	String userDirectory = System.getProperty("user.dir");
	String driverpath = userDirectory+"/datafiles/Sample Android App Login Test_v4.0_apkpure.com.apk";
	WebDriver driver;
	String Name = "test";
	String Email = "qwtest12@test.com";
	String Password = "test";
	String ConfirmPassword = "test";



		public TCM006_Register_EmailAlreeadyUsed(WebDriver driver) {
			this.driver = driver;
		}
	    ...
	    public void main() throws InterruptedException {
	    	...
	    	registerPage.tapRegister();
	    	Thread.sleep(2000);
	    	Assert.assertEquals(registerPage.verifikasiTextEmailAlreadyExist(), "Email Already Exists");
	    	driver.navigate().back();
	    }
