...
public class TCM004_Register_IncorrectEmail {
...
String ConfirmPassword = "test";
		...
		public TCM004_Register_IncorrectEmail(WebDriver driver) {
			this.driver = driver;
		}
	    ...
	    public void main() throws InterruptedException {
	    	...
	    	Thread.sleep(2000);
	    	Assert.assertEquals(registerPage.verifikasiTextIncorrectEmail(), "Enter Valid Email");
